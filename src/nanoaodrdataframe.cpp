...
//	string muonRECOtype = "NUM_TrackerMuons_DEN_genTracks";
	...
	nanoaodrdf.setupCorrections(goodjsonfname, pileupfname, pileuptag, btvfname, btvtype,/* muon_roch_fname,*/ muon_fname, muonHLTtype, /*muonRECOtype*/ muonIDtype, muonISOtype, electron_fname, electron_reco_type1,electron_reco_type2, electron_id_type, jercfname, jerctag, jercunctag,jet_veto_f_name);
