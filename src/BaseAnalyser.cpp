...
//    addVartoStore("Jet_pt");
    ...
    addVartoStore("btagbcflav_1j1b");
    addVartoStore("btagbcflav_2j1b");
    addVartoStore("btagbcflav_2j2b");
    addVartoStore("btaglflav_1j1b");
    addVartoStore("btaglflav_2j1b");
    addVartoStore("btaglflav_2j2b");
