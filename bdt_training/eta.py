...
HIST_FILE = "bdt_QCD2j1b_histograms.root"
...
FILTER_BRANCHES = ["QCDelectronChannel", "region_2j1t", "lepton_charge"]
CHUNK_SIZE = 100000
...
SUM_GEN_WEIGHTS = {
    ...
    "PROCESSED_TTbar-channel_top_UL17": 165571294.0,
    ...
    "PROCESSED_DYJetsToLL_M-50_UL17": 98719703.0,
...
# Instead of filling histograms directly, we'll collect all the values and weights
# and create the histograms at the end
collected_data = {
    "signal_top": {"values": [], "weights": []},
    "signal_antitop": {"values": [], "weights": []},
    "ttbar": {"values": [], "weights": []},
    "wjets": {"values": [], "weights": []},
    "stw": {"values": [], "weights": []},
    "dy": {"values": [], "weights": []},
    "data": {"values": []}
}
...
for file_path in tqdm(INPUT_FILES):
    ...
    try:
        with uproot.open(file_path)["outputTree"] as tree:
            ...
            required_filters_channel = set(["QCDelectronChannel"])
            ...
            for start in range(0, total_events, CHUNK_SIZE):
                ...
                #    print("its both channel")
                elif "muonChannel" in df.columns:
                    filter_condition &= (df["muonChannel"] == 1)
                 #   print("its muon channel")
                elif "QCDelectronChannel" in df.columns:
                    filter_condition &= (df["QCDelectronChannel"] == 1)
                  #  print("its just electron channel")
                ...
                if is_data:
                    ...
                    if "ST_tchannel_top" in file_name:
                        ...
                        category = "wjets"
                    elif "ST_tW" in file_name:
                        category = "stw"
                    elif "DYJets" in file_name:
                        category = "dy"
