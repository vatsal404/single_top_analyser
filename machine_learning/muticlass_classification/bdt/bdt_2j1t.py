...
#     saved as BDT_multiclass_2j1t_even.json
#
#   fold="odd":
#     df_parity = df_odd
#     70% train / 30% test, all from odd events
#     saved as BDT_multiclass_2j1t_odd.json
# ============================================
...
for fold_name, df_parity in FOLDS.items():
    ...
    plt.title(
        rf"tW vs $t\bar{{t}}$ — Optuna History (2j1t, $e\mu$, {fold_name})",
        fontsize=13
    )
    ...
    model_path = f"BDT_multiclass_2j1t_{fold_name}.json"
...
print("✅  All done!")
print("   Models saved:")
print("     BDT_multiclass_2j1t_even.json")
print("       → trained & tested on even events only")
print("     BDT_multiclass_2j1t_odd.json")
