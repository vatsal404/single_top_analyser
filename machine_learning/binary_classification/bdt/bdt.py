...
plt.title ("tW vs $t\\bar{t}$ — XGBoost Log Loss per Boosting Round (1j1t, $e\\mu$)", fontsize=13)
plt.legend(fontsize=12)
plt.grid()
plt.tight_layout()
plt.savefig("plots/roc_classifier/logloss_vs_boosting_round_1j1t_emu.png", dpi=150)
plt.close()
...
plt.title ("tW vs $t\\bar{t}$ — XGBoost AUC per Boosting Round (1j1t, $e\\mu$)", fontsize=13)
plt.legend(fontsize=12)
plt.grid()
plt.tight_layout()
plt.savefig("plots/roc_classifier/auc_vs_boosting_round_1j1t_emu.png", dpi=150)
plt.close()
...
plt.title ("tW vs $t\\bar{t}$ — BDT Score Distribution (1j1t, $e\\mu$)", fontsize=13)
plt.legend(fontsize=11)
plt.grid()
plt.tight_layout()
plt.savefig("plots/bdt_output/bdt_score_distribution_1j1t_emu.png", dpi=150)
plt.close()
...
plt.title ("tW vs $t\\bar{t}$ — Feature Importance by Gain (1j1t, $e\\mu$)", fontsize=13)
plt.tight_layout()
plt.savefig("plots/feature_importance/feature_importance_gain_1j1t_emu.png", dpi=150)
plt.close()
...
model.save_model("BDT_1j1t.json")
print("\n💾 Model saved as BDT_1j1t.json")
